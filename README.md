...
2. **模板编辑**：再复核源 EBI 的 N / S / V / X 分组，框选形态子簇建立医生模板，或在逐搏模板库中人工改型。
...
选择病例后，页面顶部会固定显示这六步、当前步骤和“下一步”按钮；医生仍可回退复查。界面保存的“已查看”只是当前浏览器中的导航进度，不等同于医学确认、审核签名或完成报告。详见 [`docs/医生复核工作流.md`](docs/医生复核工作流.md)。
...
- “打印预览”打印当前中间页面；“导出 PDF”生成带研究边界、统计对照、报告编排清单和医生结论的正式复核文档。原报告影像继续受身份信息授权开关保护，在线 Demo 不公开源报告页面。
