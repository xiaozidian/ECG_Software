...
4. **ST‑T 复核**：按原始多导联波形进行人工定位和描述；当前版本不生成自动 ST‑T 诊断。
...
- ST‑T 医生复核工作台：全天定位、12 导联能力状态、最多三导联原始波形、ISO/J/ST60/ST80 手工游标、设备原始单位相对差值、源报告线索和人工复核标注。由于幅值标定与自动定位算法尚未验证，自动 ST‑T 候选和病例 mV 输出保持禁用。
