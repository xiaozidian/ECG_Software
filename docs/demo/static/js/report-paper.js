...
(()=>{
  ...
  function render(model,entries=[]){return summary(model)+hourly(model)+stripPages(model,entries);}
  ...
  globalThis.ECGReportPaper={render,summary,hourly,stripPages,stripSvg,number,clock,wrapText};
})();
